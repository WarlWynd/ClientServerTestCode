 ...
 * Saved to: admin/src/main/resources/item-registry.json
 */
public class ItemRegistryPanel {

    public static final Path SAVE_FILE =
            Paths.get("admin/src/main/resources/item-registry.json");
    ...
    public Node build() {
        ...
        cfgScroll.setPrefWidth(240);
        cfgScroll.setMaxWidth(240);
